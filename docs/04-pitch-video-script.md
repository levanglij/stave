...
### 0:00–0:12 — Hook
> "Every song you love is a cash flow. Today, pricing that cash flow is a bilateral handshake with no standards. IPOA fixes that."
...
IPOA lets an artist mint 1,000 royalty shares on Solana in one transaction, keep 500, and sell 500. Buyers get share tokens. When revenue comes in, the artist deposits it into the work's royalty vault, and every shareholder can claim pro-rata in real time.
...
Every work listed on IPOA ships with an RRE rating — AAA through B — computed by a five-layer quantitative engine: data normalization, decay modeling with power-law and exponential fits, anomaly detection, concentration and VaR, and a standardized tier rollup. Same logic credit markets use, built for streaming data.
...
### 1:30–2:00 — The moat
The founding team owns Performing Rights Organizations. That means every rating on IPOA is backed by verified income data at the source — not aggregated from third-party APIs. No pure-tech competitor can match this. Every PRO affiliation deepens the moat.
...
### 2:50–3:00 — Close
> "Music royalties should flow at the speed of the internet, and price at the precision of credit markets. That's IPOA."
