...
1. **[Open the Stave program on Solana Explorer (devnet)](https://explorer.solana.com/address/EcJDYr1y6DTwjyGj6q2fskfyWv2733JZjffaW31bKR3Q?cluster=devnet).** Confirm the program account exists, owned by BPF Loader, with ~430KB of Rust deployed.
